...
public class AliasManager {
    ...
    public String getAlias(String original) {
        return originalToAlias.get(original.toLowerCase());
    }

    public String getOriginal(String alias) {
        return aliasToOriginal.get(alias.toLowerCase());
    }

    public boolean isAlias(String alias) {
        return aliasToOriginal.containsKey(alias.toLowerCase());
    }
    
    public boolean isProtected(String cmd) {
        return originalToAlias.containsKey(cmd.toLowerCase());
    }

    public Map<String, String> getMappings() {
        return Collections.unmodifiableMap(originalToAlias);
    }
}